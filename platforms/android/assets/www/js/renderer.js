...
var Renderer = (function () {
    function Renderer() {
        ...
        this.onWindowResize = function () {
            _this._camera.aspect = document.getElementById('content').offsetWidth / document.getElementById('content').offsetHeight;
        ...
        this._camera = new THREE.PerspectiveCamera(70, $("#content").width()/ $("#content").height(), 1.1, 5000);
